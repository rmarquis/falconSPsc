...
void ServerChatCommand (_TCHAR *msg)// me123 for remote server comands via chat
{
	//if (!g_bServer) return;
...
//					F4LeaveCriticalSection( _csect );
	   ...
	   else if (arga && argb &&!stricmp (arga, ".test"))
	   {
		  testtest = float(atoi(argb));
	   }
