...
MAPICONLIST *C_MapIcon::AddIconToList(long CampID,short type,long ImageID,float x,float y,short Dragable,_TCHAR *str,long DivID,long BrigID,long BatID,long newstatus,long newstate,DETECTOR *detector)
{
	MAPICONLIST *newitem;
	IMAGE_RSC *img = NULL;
	_TCHAR buf[10];
