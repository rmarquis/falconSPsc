...
CPObject::CPObject(ObjectInitStr* pobjectInitStr){

	mIdNum				= pobjectInitStr->idNum;
	mScale				= pobjectInitStr->scale;
	...
	mDestRect.top		= mScale * mDestRect.top;
	mDestRect.left		= mScale * mDestRect.left;
	mDestRect.bottom	= mScale * mDestRect.bottom;
	mDestRect.right	= mScale * mDestRect.right;
