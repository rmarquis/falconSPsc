...
#else
	else if(rwindex && !info && aircraft->DBrain()->WaitTime() + 60 *CampaignSeconds < SimLibElapsedTime)
#endif
	{
		//yell at them to get off runway
			if(!nextOnRunway)
...
#else
	else if( rwindex && info && info->lastContacted + 60 *CampaignSeconds < SimLibElapsedTime )
#endif
	{					
		//yell at them to get off runway
			if(!nextOnRunway)
