...
// TheTimeManager.SetTime(vuxGameTime + (unsigned long)FloatToInt32(todOffset * 1000.0F) );
   ...
   viewPoint->Setup(PlayerOptions.TerrainDistance() * FEET_PER_KM, PlayerOptions.MaxTerrainLevel(),4 , 1.2f*PlayerOptions.TerrainDistance() * FEET_PER_KM * (float)doWeather);
	 bKeepClean = FALSE; // JB 010616
...
//	MonoPrint("Initializing cockpit.. %d\n",vuxRealTime);
		...
		{
			pCockpitManager	= new CockpitManager(OTWImage, COCKPIT_FILE_6x4, TRUE, 1, FALSE, eCPVisType, eCPName, eCPNameNCTR);
			pPadlockCPManager	= new CockpitManager(OTWImage, PADLOCK_FILE_6x4, FALSE, 1, FALSE, eCPVisType, eCPName, eCPNameNCTR);
		}

		else if(DisplayOptions.DispWidth == 800 && DisplayOptions.DispHeight == 600)
		{
			pCockpitManager	= new CockpitManager(OTWImage, COCKPIT_FILE_8x6, TRUE, 1, FALSE, eCPVisType, eCPName, eCPNameNCTR);
			pPadlockCPManager	= new CockpitManager(OTWImage, PADLOCK_FILE_8x6, FALSE, 1, FALSE, eCPVisType, eCPName, eCPNameNCTR);
		}

		else if(DisplayOptions.DispWidth == 1024 && DisplayOptions.DispHeight == 768)
		{
			pCockpitManager	= new CockpitManager(OTWImage, COCKPIT_FILE_10x7, TRUE, 1, FALSE, eCPVisType, eCPName, eCPNameNCTR);
			pPadlockCPManager	= new CockpitManager(OTWImage, PADLOCK_FILE_10x7, FALSE, 1, FALSE, eCPVisType, eCPName, eCPNameNCTR);
		}
		...
		else if(DisplayOptions.DispWidth == 1280 && DisplayOptions.DispHeight == 960)
		{
			...
			{
				pCockpitManager	= new CockpitManager(OTWImage, COCKPIT_FILE_12x9, TRUE, 1, FALSE, eCPVisType, eCPName, eCPNameNCTR);
				pPadlockCPManager	= new CockpitManager(OTWImage, PADLOCK_FILE_12x9, FALSE, 1, FALSE, eCPVisType, eCPName, eCPNameNCTR);
			}

			else
			{
				pCockpitManager	= new CockpitManager(OTWImage, COCKPIT_FILE_6x4, TRUE, 2, FALSE, eCPVisType, eCPName, eCPNameNCTR);
				pPadlockCPManager	= new CockpitManager(OTWImage, PADLOCK_FILE_6x4, FALSE, 2, FALSE, eCPVisType, eCPName, eCPNameNCTR);
			}
		}
		...
		else if(DisplayOptions.DispWidth == 1600 && DisplayOptions.DispHeight == 1200)
		{
			...
			if(ResExistFile(strCPFile))
			{
				pCockpitManager	= new CockpitManager(OTWImage, COCKPIT_FILE_16x12, TRUE, 1, FALSE, eCPVisType, eCPName, eCPNameNCTR);
				pPadlockCPManager	= new CockpitManager(OTWImage, PADLOCK_FILE_16x12, FALSE, 1, FALSE, eCPVisType, eCPName, eCPNameNCTR);
			}

			else
			{
				pCockpitManager	= new CockpitManager(OTWImage, COCKPIT_FILE_8x6, TRUE, 2, FALSE, eCPVisType, eCPName, eCPNameNCTR);
				pPadlockCPManager	= new CockpitManager(OTWImage, PADLOCK_FILE_8x6, FALSE, 2, FALSE, eCPVisType, eCPName, eCPNameNCTR);
			}
		}
	...
	renderer->SetObjectTextureState(PlayerOptions.ObjectTexturesOn());
