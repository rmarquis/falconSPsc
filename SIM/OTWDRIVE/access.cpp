...
void OTWDriverClass::NVGToggle(void)
{
	...
	newRenderer->SetAlphaMode( renderer->GetAlphaMode() );
	newRenderer->SetRoofMode( renderer->GetRoofMode() );
	newRenderer->SetSmoothShadingMode( renderer->GetSmoothShadingMode() );
...
void OTWDriverClass::ToggleAlpha(void)
{
   ...
   renderer->SetAlphaMode( !renderer->GetAlphaMode() );
}
