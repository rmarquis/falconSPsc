...
MissileInputData* inputData;
 ...
 //until the dat files are up to date  inputData->SensorPrecision= (float)atoi(inputFile->GetNext());//me123
...
//me123
   ...
   inputData->boostguideSensorPrecision= (float)atof(inputFile->GetNext());//me123
   inputData->sustainguideSensorPrecision= (float)atof(inputFile->GetNext());//me123
   inputData->terminalguideSensorPrecision= (float)atof(inputFile->GetNext()); //me123
   inputData->boostguideLead = (float)atof(inputFile->GetNext());//me123
   inputData->sustainguideLead = (float)atof(inputFile->GetNext());//me123
   inputData->terminalguideLead = (float)atof(inputFile->GetNext());//me123
   inputData->boostguideGnav = (float)atof(inputFile->GetNext());//me123
   inputData->sustainguideGnav = (float)atof(inputFile->GetNext());//me123
   inputData->terminalguideGnav = (float)atof(inputFile->GetNext());//me123
   inputData->boostguideBwap = (float)atof(inputFile->GetNext());//me123
   inputData->sustainguideBwap = (float)atof(inputFile->GetNext());//me123
   inputData->terminalguideBwap = (float)atof(inputFile->GetNext());//me123
	return (inputData);
}
