...
\***************************************************************************/
DrawablePlatform::~DrawablePlatform( void )
{
...
\***************************************************************************/
void DrawablePlatform::UpdateMetrics( void *self, long listNo, Tpoint *pos, TransportStr *transList )
{
	((DrawablePlatform*)self)->UpdateMetrics( listNo, pos, transList );
}
void DrawablePlatform::UpdateMetrics( long listNo, Tpoint *pos, TransportStr *transList )
{
	DrawableObject *obj;
