...
\***************************************************************************/
void DrawableBridge::UpdateMetrics( void *self, long listNo, Tpoint *pos, TransportStr *transList )
{
	((DrawableBridge*)self)->UpdateMetrics( listNo, pos, transList );
}
void DrawableBridge::UpdateMetrics( long listNo, Tpoint *pos, TransportStr *transList )
{
	DrawableObject *obj;
