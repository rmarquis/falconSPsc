...
void ObjectDisplayList::RemoveObject( DrawableObject* object )
{
	...
	ShiAssert( object->parentList == this );

	ShiAssert(FALSE == F4IsBadReadPtr(object, sizeof *object)); // JPO
	ShiAssert(FALSE == F4IsBadReadPtr(this, sizeof *this)); // JPO
...
\*****************************************************************************/
void ObjectDisplayList::UpdateMetrics(Tpoint *pos)
{
...
/*****************************************************************************\
	...
	which are too high will go into the "highList" chain.
\*****************************************************************************/
void ObjectDisplayList::UpdateMetrics( long listNo, Tpoint *pos, TransportStr *transList )
{
	register float	x = pos->x;
	register float	y = pos->y;
//	register float	z = pos->z;
