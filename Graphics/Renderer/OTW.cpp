...
const float RenderOTW::FOG_MIN				= 0.05f;
const float RenderOTW::FOG_MAX				= 0.95f;
...

/***************************************************************************\
	Set up the prestored rendering states to be used by the terrain
\***************************************************************************/
...
\***************************************************************************/
void RenderOTW::ComputeVertexColor( TerrainVertex *vert, Tpost *post, float distance )
{
	float	alpha;
	float	fog;
	float	inv_fog;
