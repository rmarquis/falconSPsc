/***************************************************************************\
    ...
    This class provides general 3D drawing functions.
\***************************************************************************/
#include <math.h>
...
\***************************************************************************/
void Render3D::SetFOV( float horizontal_fov )
{
...
\***************************************************************************/
void Render3D::DrawSquare(ThreeDVertex* v0, ThreeDVertex* v1, ThreeDVertex* v2, ThreeDVertex* v3, int CullFlag, bool gifPicture)
{
...
\***************************************************************************/
void Render3D::DrawTriangle(ThreeDVertex* v0, ThreeDVertex* v1, ThreeDVertex* v2, int CullFlag, bool gifPicture)
{
	// Check the clipping flags on the verteces which bound this region	
	if(v0->clipFlag | v1->clipFlag | v2->clipFlag)
	{															
