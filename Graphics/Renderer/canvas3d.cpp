...
\***************************************************************************/
void Canvas3D::TextLeft( float x1, float y1, char *string, int boxed )
{
	float	x, y;
...
void Canvas3D::TextLeftVertical( float x1, float y1, char *string, int boxed )
{
	if ( !*string )
		return;
...
\***************************************************************************/
void Canvas3D::TextRight( float x1, float y1, char *string, int boxed )
{
	if ( !*string )
		return;
...
/***************************************************************************\
	...
	(The location given is used as the lower right corner of the text)
\***************************************************************************/
void Canvas3D::TextRightVertical( float x1, float y1, char *string, int boxed )
{
	if ( !*string )
		return;
...
/***************************************************************************\
	...
	(The location given is used as the horizontal center and vertical lower
	 edge of the text)
\***************************************************************************/
void Canvas3D::TextCenter( float x1, float y1, char *string, int boxed )
{
	if ( !*string )
		return;
...
void Canvas3D::TextCenterVertical( float x1, float y1, char *string, int boxed )
{
	if ( !*string )
		return;
