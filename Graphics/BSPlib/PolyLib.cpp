/***************************************************************************\
    ...
    Provides structures and definitions for 3D polygons of various types.
\***************************************************************************/
#include "stdafx.h"
...
/********************************************\
	The pointers to the active jump tables
	and rendering state tables.
\********************************************/
...
const int			*RenderStateTableNoFogPC		= NULL;
const int			*RenderStateTableNoFogNPC		= NULL;
const int			*RenderStateTableFogPC			= NULL;
const int			*RenderStateTableFogNPC			= NULL;
...
/********************************************\
	Draw state table which maps from
	polygon type to rendering state.
\********************************************/
const int RenderStateTableWithNPCTex[PpolyTypeNum] = {
	...
	STATE_TEXTURE,						// Textured
	STATE_TEXTURE_LIT,					// Textured Flat Lit
	STATE_TEXTURE,						// Textured Gouraud
	STATE_TEXTURE_GOURAUD,				// Textured Gouraud Lit
	STATE_TEXTURE_TRANSPARENCY,			// Chroma Textured
	STATE_TEXTURE_LIT_TRANSPARENCY,		// Chroma Textured Flat Lit
	STATE_TEXTURE_TRANSPARENCY,			// Chroma Textured Gouraud
	STATE_TEXTURE_GOURAUD_TRANSPARENCY,	// Chroma Textured Gouraud Lit
	...
	STATE_ALPHA_TEXTURE,				// Textured
	STATE_ALPHA_TEXTURE_LIT,			// Textured Flat Lit
	STATE_ALPHA_TEXTURE_SMOOTH,			// Textured Gouraud
	STATE_ALPHA_TEXTURE_GOURAUD,		// Textured Gouraud Lit
	STATE_ALPHA_TEXTURE_TRANSPARENCY,			// Chroma Textured
	STATE_ALPHA_TEXTURE_LIT_TRANSPARENCY,		// Chroma Textured Flat Lit
	STATE_ALPHA_TEXTURE_SMOOTH_TRANSPARENCY,	// Chroma Textured Gouraud
	STATE_ALPHA_TEXTURE_GOURAUD_TRANSPARENCY,	// Chroma Textured Gouraud Lit

	STATE_APT_TEXTURE_FILTER_PERSPECTIVE,		// Bilinear Alpha per Texel Hack
};
...
const int RenderStateTableWithPCTex[PpolyTypeNum] = {
	...
	STATE_GOURAUD,						// Gouraud
	STATE_GOURAUD,						// Gouraud Lit
	STATE_TEXTURE_PERSPECTIVE,						// Textured
	STATE_TEXTURE_LIT_PERSPECTIVE,					// Textured Flat Lit
	STATE_TEXTURE_PERSPECTIVE,						// Textured Gouraud
	STATE_TEXTURE_GOURAUD_PERSPECTIVE,				// Textured Gouraud Lit
	STATE_TEXTURE_TRANSPARENCY_PERSPECTIVE,			// Chroma Textured
	STATE_TEXTURE_LIT_TRANSPARENCY_PERSPECTIVE,		// Chroma Textured Flat Lit
	STATE_TEXTURE_TRANSPARENCY_PERSPECTIVE,			// Chroma Textured Gouraud
	STATE_TEXTURE_GOURAUD_TRANSPARENCY_PERSPECTIVE,	// Chroma Textured Gouraud Lit
	...
	STATE_ALPHA_GOURAUD,				// Gouraud
	STATE_ALPHA_GOURAUD,				// Gouraud Lit
	STATE_ALPHA_TEXTURE_PERSPECTIVE,						// Textured
	STATE_ALPHA_TEXTURE_LIT_PERSPECTIVE,					// Textured Flat Lit
	STATE_ALPHA_TEXTURE_SMOOTH_PERSPECTIVE,					// Textured Gouraud
	STATE_ALPHA_TEXTURE_GOURAUD_PERSPECTIVE,				// Textured Gouraud Lit
	STATE_ALPHA_TEXTURE_TRANSPARENCY_PERSPECTIVE,			// Chroma Textured
	STATE_ALPHA_TEXTURE_LIT_TRANSPARENCY_PERSPECTIVE,		// Chroma Textured Flat Lit
	STATE_ALPHA_TEXTURE_SMOOTH_TRANSPARENCY_PERSPECTIVE,	// Chroma Textured Gouraud
	STATE_ALPHA_TEXTURE_GOURAUD_TRANSPARENCY_PERSPECTIVE,	// Chroma Textured Gouraud Lit
...
const int RenderStateTableFogWithNPCTex[PpolyTypeNum] = {
	STATE_SOLID,						// Point
	STATE_SOLID,						// Line
	...
	STATE_GOURAUD,						// Gouraud
	STATE_GOURAUD,						// Gouraud Lit
	STATE_FOG_TEXTURE,						// Textured
	STATE_FOG_TEXTURE_LIT,					// Textured Flat Lit
	STATE_FOG_TEXTURE,						// Textured Gouraud
	STATE_FOG_TEXTURE_GOURAUD,				// Textured Gouraud Lit
	STATE_FOG_TEXTURE_TRANSPARENCY,			// Chroma Textured
	STATE_FOG_TEXTURE_LIT_TRANSPARENCY,		// Chroma Textured Flat Lit
	STATE_FOG_TEXTURE_TRANSPARENCY,			// Chroma Textured Gouraud
	STATE_FOG_TEXTURE_GOURAUD_TRANSPARENCY,	// Chroma Textured Gouraud Lit

	// With alpha (fog and alpha are mutually exclusion, so punt)
	STATE_ALPHA_SOLID,					// Flat
	STATE_ALPHA_SOLID,					// Flat Lit
	STATE_ALPHA_GOURAUD,				// Gouraud
	STATE_ALPHA_GOURAUD,				// Gouraud Lit
	...
	STATE_APT_FOG_TEXTURE_FILTER_PERSPECTIVE,		// Bilinear Alpha per Texel Hack
};

const int RenderStateTableFogWithPCTex[PpolyTypeNum] = {
	STATE_SOLID,						// Point
	STATE_SOLID,						// Line
	...
	STATE_GOURAUD,						// Gouraud
	STATE_GOURAUD,						// Gouraud Lit
	STATE_FOG_TEXTURE_PERSPECTIVE,						// Textured
	STATE_FOG_TEXTURE_LIT_PERSPECTIVE,					// Textured Flat Lit
	STATE_FOG_TEXTURE_PERSPECTIVE,						// Textured Gouraud
	STATE_FOG_TEXTURE_GOURAUD_PERSPECTIVE,				// Textured Gouraud Lit
	STATE_FOG_TEXTURE_TRANSPARENCY_PERSPECTIVE,			// Chroma Textured
	STATE_FOG_TEXTURE_LIT_TRANSPARENCY_PERSPECTIVE,		// Chroma Textured Flat Lit
	STATE_FOG_TEXTURE_TRANSPARENCY_PERSPECTIVE,			// Chroma Textured Gouraud
	STATE_FOG_TEXTURE_GOURAUD_TRANSPARENCY_PERSPECTIVE,	// Chroma Textured Gouraud Lit
...
/********************************************\
	...
	polygon type to rendering state.
\********************************************/
const int RenderStateTableWithNPCTex_Filter[PpolyTypeNum] = {
	STATE_SOLID,						// Point
	STATE_SOLID,						// Line
	...
	STATE_GOURAUD,						// Gouraud
	STATE_GOURAUD,						// Gouraud Lit
	STATE_TEXTURE_FILTER,						// Textured
	STATE_TEXTURE_LIT_FILTER,					// Textured Flat Lit
	STATE_TEXTURE_FILTER,						// Textured Gouraud
	STATE_TEXTURE_GOURAUD_FILTER,				// Textured Gouraud Lit
	STATE_TEXTURE_TRANSPARENCY,			// Chroma Textured
	STATE_TEXTURE_LIT_TRANSPARENCY,		// Chroma Textured Flat Lit
	STATE_TEXTURE_TRANSPARENCY,			// Chroma Textured Gouraud
	STATE_TEXTURE_GOURAUD_TRANSPARENCY,	// Chroma Textured Gouraud Lit
...
const int RenderStateTableWithPCTex_Filter[PpolyTypeNum] = {
	STATE_SOLID,						// Point
	STATE_SOLID,						// Line
	...
	STATE_GOURAUD,						// Gouraud
	STATE_GOURAUD,						// Gouraud Lit
	STATE_TEXTURE_PERSPECTIVE_FILTER,						// Textured
	STATE_TEXTURE_LIT_PERSPECTIVE_FILTER,					// Textured Flat Lit
	STATE_TEXTURE_PERSPECTIVE_FILTER,						// Textured Gouraud
	STATE_TEXTURE_GOURAUD_PERSPECTIVE_FILTER,				// Textured Gouraud Lit
	STATE_TEXTURE_TRANSPARENCY_PERSPECTIVE,			// Chroma Textured
	STATE_TEXTURE_LIT_TRANSPARENCY_PERSPECTIVE,		// Chroma Textured Flat Lit
	STATE_TEXTURE_TRANSPARENCY_PERSPECTIVE,			// Chroma Textured Gouraud
	STATE_TEXTURE_GOURAUD_TRANSPARENCY_PERSPECTIVE,	// Chroma Textured Gouraud Lit
...
const int RenderStateTableNoTex_Filter[PpolyTypeNum] = {
	STATE_SOLID,						// Point
	STATE_SOLID,						// Line
...
const int RenderStateTableFogWithNPCTex_Filter[PpolyTypeNum] = {
	STATE_SOLID,						// Point
	STATE_SOLID,						// Line
...
const int RenderStateTableFogWithPCTex_Filter[PpolyTypeNum] = {
	STATE_SOLID,						// Point
	STATE_SOLID,						// Line
...
/********************************************\
	Function to handle trivial accept/reject
	of potentially clipped primitives.
\********************************************/
