...
extern Objective NewObjective (short tid, VU_BYTE **stream);

extern Objective NewObjective (short tid, VU_BYTE **stream, int fromDisk);
...
extern int DecodeObjectiveDeltas(VU_BYTE **stream, FalconSessionEntity *owner);
