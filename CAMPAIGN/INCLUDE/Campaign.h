...
#define CampEnterCriticalSection()	F4EnterCriticalSection(campCritical)
#define CampLeaveCriticalSection()	F4LeaveCriticalSection(campCritical)
...
extern int LinkCampaignObjectives (Path p, Objective O1, Objective O2);
