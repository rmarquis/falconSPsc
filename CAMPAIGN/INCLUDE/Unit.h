...
class UnitClass : public CampBaseClass 
	...
	public:
		...
		virtual int GetWeaponRange (int mt, FalconEntity *target = NULL); // 2002-03-08 MODIFIED BY S.G. Need to pass it a target sometime so default to NULL for most cases
...
class UnitDeaggregationData
   ...
   public:
	...
	public:
		short			num_vehicles;
		UnitPosition	position_data[VEHICLES_PER_UNIT*3];
...
extern int DecodeUnitData (VU_BYTE **stream, FalconSessionEntity *owner);
