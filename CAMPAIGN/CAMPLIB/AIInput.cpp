...
//	TheaterXPosition	= (int)GetPrivateProfileInt("Campaign","TheaterXPosit", 512, fileName); // default place in center of korea sized theaters
//	TheaterYPosition	= (int)GetPrivateProfileInt("Campaign","TheaterYPosit", 512, fileName); // default place in center of korea sized theaters
}
