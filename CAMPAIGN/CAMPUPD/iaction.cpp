...
void instant_action::create_player_flight (void)
{
	...
	else
	{
		...
		loadout->WeaponID[3] = 0;	//Empty Racks
		loadout->WeaponCount[3] = 0;
		loadout->WeaponID[7] = 0;
		loadout->WeaponCount[7] = 0;
...
//MI we don't want AG loadout in Fighter Sweep
	...
	vuDatabase->Insert (player_flight);
...
//	new_battalion->SetInPackage(1);
	...
	vuDatabase->Insert (new_battalion);
