...
switch (bd)
	{
		case F4_BANDWIDTH_14:
		{
			vuLocalSessionEntity->SetBandWidth(1400);//me123
			ComAPISetBandwidth (3300);
			break;
		}
		...
		case F4_BANDWIDTH_28:
		{
			vuLocalSessionEntity->SetBandWidth(2800);//me123
			ComAPISetBandwidth (3300);
			break;
		}
		...
		case F4_BANDWIDTH_33:
		{
			vuLocalSessionEntity->SetBandWidth(3300);//me123
			ComAPISetBandwidth (3300);
			break;
		}
		...
		case F4_BANDWIDTH_56Modem:
		{
			vuLocalSessionEntity->SetBandWidth(4500);//me123
			ComAPISetBandwidth (3300);
			break;
		}
		...
		case F4_BANDWIDTH_56ISDN:
		{
			vuLocalSessionEntity->SetBandWidth(5600);//me123
			ComAPISetBandwidth (3300);
			break;
		}
		...
		case F4_BANDWIDTH_112:
		{
			vuLocalSessionEntity->SetBandWidth(11200);//me123
			ComAPISetBandwidth (3300);
			break;
		}
		...
		case F4_BANDWIDTH_256:
		{
			vuLocalSessionEntity->SetBandWidth(25600);//me123
			ComAPISetBandwidth (3300);
			break;
		}
		...
		case F4_BANDWIDTH_T1:
		{
			vuLocalSessionEntity->SetBandWidth(150000);//me123
			ComAPISetBandwidth (3300);
			break;
		}
	}
