...
static WORD	reds,greens,blues;
static WORD	redc,greenc,bluec;
static WORD	redm, greenm, bluem;
...
void UI95_SetScreenColorInfo(WORD r_mask,WORD g_mask,WORD b_mask)
{
