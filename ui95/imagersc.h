...
class IMAGE_RSC
{
	...
	private:
		...
		void Blend8BitTransparent(long doffset,long dwidth,WORD *dest,long front,long back);
		void Blend8BitPart(long soffset,long scopy,long ssize,long doffset,long dwidth,WORD *dest,long front,long back);
		void Blend8BitTransparentPart(long soffset,long scopy,long ssize,long doffset,long dwidth,WORD *dest,long front,long back);

		// Straight Blending
		void Blend16BitFast(WORD *dest,long front,long back);
		void Blend16Bit(long doffset,long dwidth,WORD *dest,long front,long back);
		void Blend16BitTransparentFast(WORD *dest,long front,long back);
		void Blend16BitTransparent(long doffset,long dwidth,WORD *dest,long front,long back);
		void Blend16BitPart(long soffset,long scopy,long ssize,long doffset,long dwidth,WORD *dest,long front,long back);
		void Blend16BitTransparentPart(long soffset,long scopy,long ssize,long doffset,long dwidth,WORD *dest,long front,long back);
